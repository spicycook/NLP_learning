...
def prepare_data_ablt(non_text_cat0, non_text_num0, text_var0):
    ...
    if non_text_cat0:
        ...
        non_text_all0 = non_text_all0.fillna(-99999)
    elif non_text_num0:
...
name_ablt = ['pdd', 'mdsV', 'moc', 'age', 'fsd', 'fr', 'mini', 'ftt', 'abc', 'gen', 'rac', 'eth', 'edu', 'f6m', 'fler', 'mdsBi', 'HY', 'loc', 'fcl', 'fog', 'clst', 'ngrm']
...
text_box = plt.text(left_margin , top_margin - line_spacing*20, all_notes, fontsize=10,
...
train_X1, test_X1 = prepare_data_ablt(['minibestest_total'], [], ['ngram', 'cluster'])
xgb_classifier = xgb_classifier.fit(train_X1, classes)
predictions = xgb_classifier.predict(test_X1)
# predictions = xgb_classifier.predict(train_X1)
accuracy, f1_micro, f1_macro = accuracy_score(test_classes, predictions), f1_score(test_classes, predictions, average='micro'), f1_score(test_classes, predictions, average='macro')
# accuracy, f1_micro, f1_macro = accuracy_score(classes, predictions), f1_score(classes, predictions, average='micro'), f1_score(classes, predictions, average='macro')
# Print the results
print(f'Accuracy: {accuracy:.2f}')
print(f'Micro-averaged F1 Score: {f1_micro:.2f}')
print(f'Macro-averaged F1 Score: {f1_macro:.2f}')
